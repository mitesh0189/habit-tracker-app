...
function ProgressCards() {
  ...
  const cardsClass = classNames(
    'grid', 'grid-cols-[repeat(auto-fit,_minmax(10rem,_1fr))]', 'gap-4', 'px-4', 'py-6', 'bg-gradient-to-br', 'from-blue-50', 'to-gray-100',
    'rounded-xl', 'shadow-lg', 'xl:grid-cols-[repeat(2,_minmax(12rem,_1fr))]', 'sm:px-8', 'xl:py-10'
  );
